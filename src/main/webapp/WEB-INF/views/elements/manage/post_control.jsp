...
"><i class="bi bi-check2-square"></i> Approve</a> |
	<a href="#" id="reject-link" class="post-reject fs-5" style="margin-left:5px;"><i class="bi bi-x-square"></i> Reject</a>
	<form:form method="POST" action="manage/posts/${post.id}/reject.htm" modelAttribute="post" id="reject-form" style="display: none; margin-left:5px; width: 100%;">
		<button type="submit" class="post-reject fs-5" style="background: none; border: none; padding: 0; color: #007bff; text-decoration: none; cursor: pointer; width: 100px;"><i class="bi bi-x-square"></i> Reject</button>
		<div class="reason w-100" style="margin-left:5px;">
			<form:input class="reason-context w-100" path="rejectReason" type="text" placeholder="Reason" />
		</div>
	</form:form>
</div>
