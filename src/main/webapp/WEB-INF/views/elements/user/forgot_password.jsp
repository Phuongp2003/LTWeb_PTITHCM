...
<div class="user-cpass container-fluid w-25 fs-4 m-auto">
	...
	<form method="POST" action="user/forgot-password.htm">
		
		<div class="input-box">
			<label>Email</label>
			<input type="mail" name="email" class="email-input" placeholder="Email" />
		</div>
		<button type="submit" class="login-btn">Nhận mật khẩu</button>
	</form>
</div>
