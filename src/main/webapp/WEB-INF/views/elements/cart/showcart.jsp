                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-10">
                                                <div class="partcenter card-body">
                                                    <div class="content">
                                                        <h5 class="card-title">${detail.cartdetail_book.TENSACH}</h5>
                                                        <p class="card-text">
                                                        ...
                                                        <div class="wrapper">
                                                            ...
                                                            <div class="group-input">
                                                                ...
                                                                <input type="text" value="${detail.SOLUONG}" class="input" id="quantity-${status.index}" readonly />
                                                    ...
                                                    <a href="cart/delete-cart-detail/${detail.cartdetail_book.MASACH}.htm" class="btn-delete btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm ${detail.cartdetail_book.TENSACH} không?')">Xóa sản phẩm </a>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="flexCheckChecked-${status.index}"></label>
                                                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 pd5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="check-out.htm" class="btn btn-primary" >Thanh toán</a>
                            </div>
                        </div>
                    </div>
                </div>
