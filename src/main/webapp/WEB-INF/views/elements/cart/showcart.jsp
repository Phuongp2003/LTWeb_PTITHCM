    ...
    <div class="product">
      <c:choose>
        ...
        <c:otherwise>
          <div class="row">
            <div class="col-md-8">
              <c:set var="hasSelectedProduct" value="false" />
                        ...
                        <div class="form-check ml-auto">
                          <c:choose>
                            <c:when test="${detail.CHON == 1}">
                              ...
                              <c:set var="hasSelectedProduct" value="true" />
                            </c:when>
                            <c:otherwise>
                              <input class="form-check-input" type="checkbox" id="flexCheckChecked-${status.index}" onclick="updateHiddenInput(${status.index}); updateHasSelectedProduct(${status.index});">
                            </c:otherwise>
                          </c:choose>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <div>
                            <form:form action="cart/update-cart-detail.htm" modelAttribute="detail">
                              ...
                              <button type="submit" class="btn btn-primary" onclick="updateCart(${status.index})">Chỉnh
                                sửa</button>
